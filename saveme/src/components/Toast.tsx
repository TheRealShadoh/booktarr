...
const Toast: React.FC<ToastProps> = ({ 
  ...
  return (
    <div className={`fixed top-4 right-4 z-[60] flex items-center space-x-2 p-4 rounded-lg border backdrop-blur-sm ${typeStyles[type]} animate-slide-in toast-${type}`} data-testid="toast">
