...
// Types
export type CurrentPage = 'library' | 'settings' | 'wanted' | 'activity' | 'logs' | 'add' | 'collections' | 'advanced-search' | 'analytics' | 'book-details' | 'recommendations' | 'challenges' | 'series-management' | 'series-details' | 'release-calendar' | 'author-profile' | 'authors' | 'publishers' | 'seasonal' | 'magazines' | 'error-boundary-test' | 'insights';
